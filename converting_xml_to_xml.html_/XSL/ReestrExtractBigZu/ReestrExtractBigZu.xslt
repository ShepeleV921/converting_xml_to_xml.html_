...
b){b=C(b);this.colors_.push({offset:a,color:b.color,alpha:b.alpha})};G_vmlCanvasManager=G;CanvasRenderingContext2D=w;CanvasGradient=u;CanvasPattern=F}();</script><![endif]]]>
					</xsl:comment>
...
0,this.id)}a.preventDefault&&a.preventDefault();a.returnValue=false}}function up(){button="NONE"}function down(a){if(!a)a=window.event;a!=void 0&&(button=a.which==null?a.button<2?"LEFT":a.button==4?"MIDDLE":"RIGHT":a.which<2?"LEFT":a.which==2?"MIDDLE":"RIGHT")};
						]]>
							...
							<table class="t" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								<tr height="30px">
									...
									<th rowspan="2" width="25%">
										Описание закрепления<br/>на местности
									</th>
		...
		<table class="t" border="1" cellpadding="2" cellspacing="0" width="100%">
			...
			<tr>
				<td width="25%">
					...
					<xsl:element name="span">
						<xsl:attribute name="name">
							part_list_<xsl:value-of select="$curRazd"/>
						</xsl:attribute>
				...
				<td width="25%">
					...
					<xsl:element name="span">
						<xsl:attribute name="name">
							total_part_<xsl:value-of select="$curRazd"/>
						</xsl:attribute>
      ...
      <xsl:call-template name="newPage"/>
		...
		<div class="title2">
			...
			<xsl:choose>
				...
				<xsl:when test="$pageNumber='3.1'">
					<b>Описание местоположения земельного участка</b>
				</xsl:when>
				<xsl:when test="$pageNumber='3.2'">
					<b>Описание местоположения земельного участка</b>
				</xsl:when>
				<xsl:when test="$pageNumber='4'">
					<b>Сведения о частях земельного участка</b>
				</xsl:when>
				<xsl:when test="$pageNumber='4.1'">
					<b>Сведения о частях земельного участка</b>
				</xsl:when>
				<xsl:when test="$pageNumber='4.2'">
					<b>Сведения о частях земельного участка</b>
				</xsl:when>
				...
				<th>
					...
					<table class="t" border="1" cellpadding="2" cellspacing="0" width="100%">
						...
						<tr valign="top" height="40px">
							...
							<th style="text-align:center" rowspan="2">
								Кадастровые номера<br/> смежных участков
							</th>
							<th style="text-align:center" rowspan="2">
								Сведения об адресах правообладателей<br/> смежных земельных участков
							</th>
						</tr>
