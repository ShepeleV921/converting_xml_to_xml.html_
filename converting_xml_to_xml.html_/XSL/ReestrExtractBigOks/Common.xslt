				...
				<xsl:if test="$spatialElement|$spatialElementPart">
					<xsl:attribute name="onload">
						...
						<xsl:call-template name="BodyFunctionCycle">
							<xsl:with-param name="total" select="count($spatials)"/>
								...
								<table class="tbl_section_topsheet">
									<tr>
										...
										<th class="vtop" style="text-align: center;">
											Кадастровый номер<br/>помещения, машино-места
										</th>
										<th class="vtop" style="text-align: center;">Номер этажа (этажей)</th>
										<th class="vtop" style="text-align: center;">
											Обозначение (номер) помещения,<br/>машино-места на поэтажном плане
										</th>
								...
								<th>
									<table class="tbl_section_topsheet">
										<tr>
											...
											<th colspan="2">
												Учетный номер части <xsl:value-of select="$parent_node/@NumberRecord"/>
											</th>
										</tr>
										<tr>
											<th colspan="4">
								...
								<table class="tbl_section_topsheet">
									...
									<tr>
										...
										<th rowspan="2" style="text-align: center;">
											Средняя квадратическая погрешность определения координат<br/>характерных точек контура части объекта недвижимости, м
										</th>
