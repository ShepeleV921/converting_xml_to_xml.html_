	...
	<xsl:template name="Form1">
		...
		<table class="tbl_section_topsheet">
			...
			<tr>
				<th class="left vtop">
					<xsl:choose>
						<xsl:when test="/kp:KPOKS/kp:Realty/kp:Uncompleted">
				...
				<th colspan="3" class="left vtop">
					<xsl:choose>
						<xsl:when test="kp:Assignation/ass:AssignationCode=206001000000">
							<xsl:text>Нежилое помещение</xsl:text>
						</xsl:when>
						<xsl:when test="kp:Assignation/ass:AssignationCode=206002000000">
							<xsl:text>Жилое помещение</xsl:text>
						</xsl:when>
						<xsl:otherwise>
							...
							<th>
								<table class="tbl_section_topsheet">
									<tr>
										...
										<th class="vtop" style="text-align: center;">
											Содержание ограничения в использовании или ограничения права на<br/>объект недвижимости или обременения объекта недвижимости
										</th>
									</tr>
									<!--<xsl:if test="not(self::kp:Flat)">
										<tr>
